  ...
  <div class="container">
    ...
    <div id="sidebar">
      ...
      <div v-if="connected" id="connection-status-container">
        ...
        <div id="connection-status-description">Bot connected</div>
      ...
      <div id="user-bar" v-if="user">
        <img
          :src="`https://cdn.discordapp.com/avatars/${this.user.id}/a_a765d9f18091817029760eb739c1ec1d.webp?size=256`"
          alt=" "
        />
        <div id="name-tag">
          <div id="username">
